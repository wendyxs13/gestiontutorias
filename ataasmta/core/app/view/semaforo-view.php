...
$hora = date("H:i:s");
  $sql2 = "INSERT INTO accesos (fecha, hora, usuario, ip, script, tipo,comentarios) Values 
    ('" . date("Y-m-d")  . "','" . date("H:i:s")  . "','".strtoupper($_SESSION['user'])."','','SEMAFORO','".$_SESSION['tipo']."',
    'SEMAFORO')";
    $con->query($sql2);
    ////////////
?>
          ...
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              <div class="col">
                ...
                <h2 class="page-title">
                  SEMAFORO DE DESEMPEÑO ACADÉMICO
                </h2>
              </div>
              <!-- Page title actions -->
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#getsemaforo").submit(function(e){
			...
			$.post("./?action=getsemaforo",$("#getsemaforo").serialize(), function(data){
				$("#results").html(data);
			});
