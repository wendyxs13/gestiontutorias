<?php
class DivisionesData extends Extra {
	public static $tablename = "divisiones";
	public $extra_fields;
	...
	public static function getById($id){
		...
		return Model::one($query[0],new DivisionesData());
	}
	...
	public static function getAllRoot(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new DivisionesData());
	}
