...
<html lang="en">
  <head>
    ...
    <!-- .:: FAVICONS ::. -->
    <!--<link rel="icon" href="dist/img/favicon.jpg" type="image/jpg">-->
    <link rel="icon" type="image/x-icon" href="dist/img/favicon2.ico" />
        ...
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              ...
              <span class="mt-3 ms-7 text-primary"> Monitoreo de Trayectorias Académicas del Alumnado</span>
          </h1>
...
<div class="page" style="margin-top: -30px;">
      <div class="container container-tight py-4">
        ...
        <div class="card card-md">
          <div class="card-body">
            <h2 class="h2 text-center mb-5 text-primary">Monitoreo de Trayectorias Académicas del Alumnado</h2>
