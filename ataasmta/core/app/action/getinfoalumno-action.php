...
<td><div align="right">Matrícula</div></td>
  ...
  <tr>
    <td  ><div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>PROBABILIDAD INICIAL DE REZAGO</strong></font></div></td>
    <td  >&nbsp;</td>
    <td  ><strong>

    <?= '<span style="color:' . 
    ($row["probabilidad"] > 0 && $row["probabilidad"] <= 0.333 ? 'green' : 
    ($row["probabilidad"] > 0.333 && $row["probabilidad"] <= 0.666 ? 'yellow' : 'red')) . 
    ';">' . $row["probabilidad"] . '</span>'; ?>

    

 <!-- Este fragmento de php no está trabajando -->
<?php 
$prom = $row["PROM"];
 $edad = $row["EDCAL"];
$puntaje = $row["PUNTAJE"];
...
/*if(  ($prom <= 7 && (($edad>=26 && $edad <=30) || $edad >30) && ($puntaje >=500 && $puntaje <=700) ) || $puntaje <=500 ){ echo "<b>RIESGO ALTO</b>"; }
else if( ( ($prom >= 7.01 && $prom<=9) && (($edad>=21 && $edad <=25) || $edad <19) && ($puntaje >=701 && $puntaje <=800) ) || ($puntaje >=701 && $puntaje <=800)){ echo "<b>RIESGO NORMAL</b>"; }
else if(  ($prom >= 9.01 && $prom<=10) && (($edad>=19 && $edad <=20)) && ($puntaje >=801 && $puntaje <=1000) ) || ($puntaje >=801 && $puntaje <=1000)){ echo "<b>RIESGO BAJO</b>"; }
else { echo "<b>RIESGO NORMAL</b>"; }*/

/*if($prom <= 7 && (($edad>=26 && $edad <=30) || $edad >30) && ($puntaje >=500 && $puntaje <=700) ){ echo "<b>RIESGO ALTO</b>"; }
else if(($prom >= 7.01 && $prom<=9) || (($edad>=21 && $edad <=25) || $edad <19) || ($puntaje >=701 && $puntaje <=800) ){ echo "<b>RIESGO NORMAL</b>"; }
else if(($prom >= 9.01 && $prom<=10) || (($edad>=19 && $edad <=20)) || ($puntaje >=801 && $puntaje <=1000) ){ echo "<b>RIESGO BAJO</b>"; }
else { echo "<b>SIN CLASIFICACION</b>"; } */
/*
...
?>
  ...
  <tr>
    ...
    <td><strong>
    <?= '<span style="color:' . 
    (($row["NTRI"] - $row["TRI_UBICA"]) <= 0 ? 'green' : 
    (($row["NTRI"] - $row["TRI_UBICA"]) > 3 ? 'red' : 'yellow')) . 
    ';">' . ($row["NTRI"] - $row["TRI_UBICA"]) . '</span>'; ?>
</strong></td>
  ...
  <tr>
    <td  ><div align="right">Edad al ingresar</div></td>
    <td  >&nbsp;</td>
    <td  ><strong>
      <?=($row["EDCAL"])?>
    </strong></td>
