...
$sql_rojo = "SELECT * FROM alumnos 
    WHERE (genero = 'Sí' AND probabilidad > 0.666)";
...
$sql_verde = "SELECT * FROM alumnos 
    WHERE (genero = 'Sí' AND (probabilidad > 0 AND probabilidad <= 0.333))";
...
$sql_ambar = "SELECT * FROM alumnos 
    WHERE (genero = 'Sí' AND (probabilidad > 0.333 AND probabilidad <= 0.666))";
