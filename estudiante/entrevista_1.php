        ...
        <div class="col-md-12 mt-4"  >
          ...
          <form id="formulario" >
            ...
            <div class="form-group row ">
              ...
              <div class="col-md-6" >
                <input type="text" required class="form-control" id="txt1" name="txt1" maxlength="35" placeholder="Nombre(s)" value="<?php echo $nombre; ?>">
              </div>
            </div>
            ...
            <div class="form-group row ">
              ...
              <div class="col-md-6" >
                <input type="text" required class="form-control" id="txt3" name="txt3" maxlength="30" placeholder="Correo electrónico institucional"  value="<?php echo $correo; ?>">
              </div>
            </div>
...
<!---- otra etiqueta 1 ----->
            ...
            <div class="form-group row">
              <label class="col-md-2 col-form-label" ><b>¿Cuál es la última calificación que obtuviste?</b> </label>
              <div class="col-md-6" >
                ...
                <select name="txt12" id="txt12" class="custom-select" required="" >
                  <option value="">Seleccione una opción</option>
...
<!---- etiqueta 8 y 9 ----->
            ...
            <div class="form-group row mt-5">
              ...
              <div class="col-md-8">
                <button type="button" class="btn btn-primary btn_03"  onclick="enviarDatos1();" >Enviar</button>
                
                <!-- <input type="submit" class="btn btn-primary btnGreen1"  value="Enviar"> -->
              </div>
