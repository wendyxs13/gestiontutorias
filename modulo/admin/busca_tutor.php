...
<!--     <link rel="stylesheet" href="css/bootstrap.min.css" >   --> 
  ...
  <body>
      ...
      <div class="row mt-0  justify-content-around">
          <div class="col-md-11 mt-2 mb-2 p-3 pt-2 pl-5 pr-5 shadow rounded" style="min-height: 75vh;">
            <div class="row m-2 p-2 d-flex justify-content-between">
              <h3><b style="color: #1C499A; text-transform: uppercase;">Buscar información de tutor</b></h3>
              ...
              <form class="form-inline">  
                <div class="form-group mx-sm-3 mb-2">
                  <label for="matri">Número económico: </label>
                  <input type="text" class="form-control ml-2" id="num_eco" name="num_eco" placeholder="Número económico">
                </div>
                <button type="button" class="btn btn-primary btn_10 pl-3 pr-4 mx-sm-3 mb-2" onclick="busca_tutor();">
                  <img class="img-fluid mr-2 mb-1" src="../../img/buscar.png" alt="">Buscar
                </button>

              </form>

              <div class="mb-5 mx-3" id="respuesta_no_eco">
              </div>
    ...
    <!-- modal -->
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modal_lista">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h3 class="text-uppercase">Estudiantes asignados</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
              </div>
              <div id="lista_est" class="pr-4 pl-4">
    ...
    <!-- modal datos tutor -->
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel2" aria-hidden="true" id="modal_datos_tutor">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div id="datos_x_tutor" class="pr-4 pl-4">
  ...
  <script src="../../js/bootstrap.bundle.min.js"></script>
  <script src="../../js/sweetalert.min.js"></script>
  <script src="../../js/admin/busca_tutor.js"></script>
