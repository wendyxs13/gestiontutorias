...
$num_eco = base64_decode($num_eco_codi); 
$num_eco = htmlspecialchars($num_eco);

$trim = base64_decode($trim_codi); 
$trim = htmlspecialchars($trim);

$query_tutor = "SELECT nombre, ap, am, division, depto FROM ges_registro_tutor  where num_eco = ?;";
$stmt_tutor = $connection->prepare($query_tutor);
$stmt_tutor->execute(array($num_eco));
$total_tutor = $stmt_tutor->rowCount();

while ($row_tu = $stmt_tutor->fetch()) {
  $tutor_01 = "{$row_tu['nombre']}";
  $tutor_02 = "{$row_tu['ap']}";
  $tutor_03 = "{$row_tu['am']}";
  $tutor_04 = "{$row_tu['division']}";
}
...
$stmt_exi->execute(array($num_eco, $trim));
    ...
    <div class="row mt-0 ">
        ...
        <div id="secc_1"><!-- secc_01 -->
            ...
            <p style="font-size:1em;"  class="ml-4 texto_01">
                <b>Nombre:</b> <?php echo $tutor_01." ".$tutor_01." ".$tutor_03; ?> <br>
                <b>Número económico:</b> <?php echo $num_eco; ?> <br>
                <b>División académica:</b> <?php echo $tutor_04; ?><br>
            ...
            <table class="table " width="99%" >
                <thead class="backBlue2">
                    <tr>
                        <th scope="col" style=" text-align: left;" width="2%">#</th>                  
                        <th scope="col" style=" text-align: left;" width="28%">Nombre</th>
                        <th scope="col" style=" text-align: left; padding-left: 5px;" width="12%">Matrícula</th>
                        <th scope="col" style=" text-align: left; padding-left: 10px;" width="25%">Licenciatura</th>
                        <th scope="col" width="10%">Calificación inicial</th>
                        <th scope="col" width="13%">Trimestre cursado</th>
                        <th scope="col" width="10%">Calificación final</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    if ($total > 0) {
                        ...
                        while ($row = $stmt_exi->fetch()) {
                            ...
                            <tr>
                                ...
                                <td style=" padding-left: 5px;"><?php echo $nombre; ?></td>
                                <td style=" padding-left: 5px;" ><?php echo $matricula; ?></td>
                                <td style=" padding-left: 10px;" ><?php echo $lic; ?></td>
                                <td style=" text-align:center;" ><?php echo $promedio; ?></td>
                                <td style=" text-align:center;" ><?php echo $trime; ?></td> 
                                <td style=" text-align:center;" ><?php echo $pf; ?></td>                                    
                            </tr>
                            <?php
                        }
                    }
        ...
        *******************************************-->
        <?php
        $query_ses = "SELECT DATE_FORMAT(fecha, '%d/%m/%Y') as fecha, horas, temas, modalidad FROM ges_tutoria_grupal_2 WHERE num_eco = $num_eco and trim_informe = '$trim';"; //AND trim_informe_g2 = ?
        ...
        ?>
        <div id="secc_2" style="width:95%"><!-- secc_02 -->                
            <p>
                <b>III.  De las sesiones de tutoría </b>
            </p>
            <table id="table_sesion" class="table">
                <thead class="backBlue2">
                    <tr>                  
                        <th scope="col" style=" text-align: left;" width="5%"># </th>
                        <th scope="col" style=" text-align: left;" width="10%">Fecha</th>
                        <th scope="col" style=" text-align: left;" width="10%">Duración</th>
                        <th scope="col" style=" text-align: left;" width="55%">Temas abordados</th>
                        <th scope="col" style=" text-align: left;" width="20%">Modalidad</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    if ($totalses > 0) {
                        ...
                        while ($row = $stmt_ses->fetch()) {
                            ...
                            ?>
                            <tr>
                                <td style="text-align: left;"><?php echo $nses; ?></td>
                                <td style="text-align: left;" ><?php echo $fecha; ?></td>
                                <td style="text-align: left;"><?php
                                    echo $horas;
                                    echo $horas == 1 ? ' hora' : ' horas';
                                    ?></td>
                                <td style=" text-align: left;"><?php echo $temas; ?></td> 
                                <td style=" text-align: left;"><?php echo $modalidades[$modal]; ?></td>                                    
                            </tr>
                            <?php
                        }
                    } else {
        ...
        *******************************************-->
        ...
        $query_per = "SELECT tutoria_falta as falta, "
                ...
                . " FROM ges_tutoria_grupal_3 WHERE num_eco = $num_eco and trim_informe = '$trim' ; ";
        //AND trim_informe_g2 = ?
