            ...
            <section>
              <ul class="nav nav-pills nav-pills-icons" role="tablist">
                <li class="nav-item btn_reporte">
                  <a class="nav-link" href="index_trim.php?x=<?php echo urlencode(base64_encode("23-O")); ?>" >
                    <i class="material-icons">calendar_month</i>
                    TRIMESTRE 23-O
                  </a>
                </li>
                <li class="nav-item btn_reporte">
                  <!-- <a class="nav-link" href="index_trim.php?x=<?php echo urlencode(base64_encode("24-I")); ?>" > -->
                    <i class="material-icons">calendar_month</i>
                    TRIMESTRE 24-I
                  <!-- </a> -->
                </li>
