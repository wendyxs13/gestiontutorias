          ...
          <div class="form-container">
                ...
                <div class="card-body">
                  <div class=" align-items-start"> 
                    <div class="form-check mr-4">
                      <input class="form-check-input" type="radio" name="asistencia" id="asistencia-1" value="1" onclick="asiste(1);">
                    ...
                    <div class="form-check mr-4">
                       <input class="form-check-input" type="radio" name="asistencia" id="asistencia-2" value="2" onclick="asiste(2);">
                    ...
                    <div class="form-check mr-4">
                      <input class="form-check-input" type="radio" name="asistencia" id="asistencia-3" value="3" onclick="asiste(3);">
                    ...
                    <div class="form-check mr-4">
                      <input class="form-check-input" type="radio" name="asistencia" id="asistencia-4" value="4" onclick="asiste(4);">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="d-flex align-items-start"> 
                  <div class="form-check mr-4">
                    <input class="form-check-input" type="radio" name="radio3" id="radio3-1" value="Nada satisfactorio">
                  ...
                  <div class="form-check mr-4">
                     <input class="form-check-input" type="radio" name="radio3" id="radio3-2" value="Regular">
                  ...
                  <div class="form-check mr-4">
                    <input class="form-check-input" type="radio" name="radio3" id="radio3-3" value="Bueno">
                  ...
                  <div class="form-check mr-4">
                    <input class="form-check-input" type="radio" name="radio3" id="radio3-4" value="Muy bueno">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start"> 
                      <div class="form-check mr-4">
                        <input class="form-check-input" type="radio" name="radio5" id="radio5-1" value="1-3">
                      ...
                      <div class="form-check mr-4">
                         <input class="form-check-input" type="radio" name="radio5" id="radio5-2" value="4-7">
                      ...
                      <div class="form-check mr-4">
                        <input class="form-check-input" type="radio" name="radio5" id="radio5-3" value="8-11">
                      ...
                      <div class="form-check mr-4">
                        <input class="form-check-input" type="radio" name="radio5" id="radio5-4" value="+12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="d-flex align-items-start"> 
                    <div class="form-check mr-4">
                      <input class="form-check-input" type="radio" name="radio6" id="radio6-1" value="15-30">
                    ...
                    <div class="form-check mr-4">
                       <input class="form-check-input" type="radio" name="radio6" id="radio6-2" value="30-60">
                    ...
                    <div class="form-check mr-4">
                      <input class="form-check-input" type="radio" name="radio6" id="radio6-3" value="61-90">
                    ...
                    <div class="form-check mr-4">
                      <input class="form-check-input" type="radio" name="radio6" id="radio6-4" value="+90">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">                
                      <div class="d-flex flex-wrap align-items-start">  
                        <div class="form-check col-md-10">
                          <input class="form-check-input" type="checkbox" name="check7-1" id="check7-1" value="1">
                    ...
                    <div class="col-md-8 mt-1">
                      ...
                      <div class="d-flex flex-wrap align-items-start">  
                        <div class="form-check col-md-5 mt-2">
                          <input class="form-check-input" type="checkbox" name="check7-2" id="check7-2" value="1">
                          <label class="form-check-label" for="check7-2">
                          Comprensión lectora
                          </label>
                        </div>
                        <div class="form-check col-md-7 mt-2">
                          <input class="form-check-input" type="checkbox" name="check7-3" id="check7-3" value="1">
                          <label class="form-check-label" for="check7-3">
                          Habilidades de conocimiento matemático
                          </label>
                        </div>
                        <div class="form-check col-md-5 mt-2">
                          <input class="form-check-input" type="checkbox" name="check7-4" id="check7-4" value="1">
                          <label class="form-check-label" for="check7-4">
                          Argumentación
                          </label>
                        </div>
                        <div class="form-check col-md-7 mt-2">
                          <input class="form-check-input" type="checkbox" name="check7-5" id="check7-5" value="1">
                    ...
                    <div class="col-md-8 mt-1">
                      ...
                      <div class="d-flex flex-wrap align-items-start">  
                        <div class="form-check col-md-5 mt-2">
                          <input class="form-check-input" type="checkbox" name="check7-6" id="check7-6" value="1">
                          <label class="form-check-label" for="check7-6">Trabajo en equipo</label>
                        </div>
                        <div class="form-check col-md-6 mt-2">
                          <input class="form-check-input" type="checkbox" name="check7-7" id="check7-7" value="1">
                          <label class="form-check-label" for="check7-7">Hablar en público</label>
                        </div>
                        <div class="form-check col-md-5 mt-2">
                          <input class="form-check-input" type="checkbox" name="check7-8" id="check7-8" value="1">
                          <label class="form-check-label" for="check7-8">Integración al medio universitario</label>
                        </div>
                        <div class="form-check col-md-6 mt-2">
                          <input class="form-check-input" type="checkbox" name="check7-9" id="check7-9" value="Otro" onclick="check_otro('7-9',1);">
                    ...
                    <div id="div1" class="col-md-12 mt-2" >
                      <div class="d-flex align-items-start">
                        ...
                        <div class="col-md-5 ml-5"  >
                          <input type="text" required class="form-control" id="txt8" name="txt8" maxlength="90" placeholder="">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-group row ">
                    <div class="col-md-10" >
                      <div class="d-flex align-items-start"> 
                        ...
                        <div class="form-check mr-4">
                          <input class="form-check-input" type="radio" name="radio9" id="radio9-1" value="Dudas académicas" onclick="h_otro(2);">
                        ...
                        <div class="form-check mr-4">
                           <input class="form-check-input" type="radio" name="radio9" id="radio9-2" value="Dudas sobre tramites escolares" onclick="h_otro(2);">
                        ...
                        <div class="form-check mr-4">
                          <input class="form-check-input" type="radio" name="radio9" id="radio9-3" value="otro" onclick="s_otro(2);">
                    ...
                    <div id="div2" class="col-md-12 mt-2" >
                      <div class="d-flex align-items-start">
                        ...
                        <div class="col-md-5" >
                          <input type="text" required class="form-control" id="txt10" name="txt10" maxlength="90" placeholder=""   >
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-group row ">
                    <div class="col-md-10" >
                      <div class="d-flex align-items-start"> 
                        ...
                        <div class="form-check mr-4">
                          <input class="form-check-input" type="radio" name="radio11" id="radio11-1" value="Si" onclick="s_otro(3);">
                        ...
                        <div class="form-check mr-4">
                           <input class="form-check-input" type="radio" name="radio11" id="radio11-2" value="No hubo recomendación" onclick="h_otro(3);">
                    ...
                    <div id="div3" class="col-md-12 mt-2" >
                      <div class="d-flex align-items-start">
                        ...
                        <div class="col-md-5" >
                          <input type="text" required class="form-control" id="txt12" name="txt12" maxlength="90" placeholder="">
                        </div>
                      </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                  <textarea class="form-control" id="txt13" name="txt13" rows="3"></textarea>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                   <textarea class="form-control" id="txt14" name="txt14" rows="3"></textarea> 
                </div>
            </div>
             ...
             <div class="card">
                ...
                <div class="card-body">
                  <textarea class="form-control" id="txt15" name="txt15" rows="3"></textarea>
            ...
            <div class="card">
                ...
                <div class="card-body">
                  <textarea class="form-control" id="txt16" name="txt16" rows="3"></textarea>
                </div>
            </div>
